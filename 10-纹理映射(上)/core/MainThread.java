...
public class MainThread extends JFrame implements KeyListener{
	...
	public MainThread(){
		...
		for(int i = 0; i < bunnies.length; i++) {
			bunnies[i] = new VertexBufferObject(bunnyMesh.vertices, null, bunnyMesh.normals, bunnyMesh.indices, lightSource1, kd, ks);
		}
		...
		Vector3D[][] backgroundUVDirections = new Vector3D[4][];
		...
		background.textureScaleX = 0.125f;
		background.textureScaleY = 0.125f;
		...
		Vector3D[][] groundUVDirections = new Vector3D[4][];
		...
		ground.textureScaleX = 0.25f;
		ground.textureScaleY = 0.25f;
